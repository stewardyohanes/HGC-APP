...
export default function MelayaniPage() {
  return (
    <div className="min-h-[70vh] bg-zinc-900 text-white px-6 py-20">
      <div className="mx-auto w-full max-w-6xl">
        <div className="text-center">
          ...
          <p className="mt-3 text-gray-300 md:text-lg">
            Kita diselamatkan untuk melayani. Dengan karunia yang Tuhan beri,
            kita membangun tubuh Kristus. "Setiap orang telah menerima karunia
            yang berbeda-beda, hendaklah ia mempergunakannya untuk melayani"
            (1Ptr 4:10).
          </p>
        </div>
        ...
        <div className="mt-14 overflow-hidden rounded-lg border border-white/10 bg-gradient-to-br from-emerald-600/20 to-emerald-400/10 p-6 text-center">
          <h2 className="text-xl md:text-2xl font-bold">Siap Melayani?</h2>
          <p className="mt-2 text-gray-300">
            Kirimkan minat dan area pelayananmu. Tim kami akan menghubungi untuk
            orientasi singkat dan penjadwalan.
          </p>
